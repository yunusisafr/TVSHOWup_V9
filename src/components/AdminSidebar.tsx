...
import { LayoutDashboard, Film, Users, Settings, FileText, LogOut, Database, PlusCircle, Languages } from 'lucide-react';
...
const AdminSidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    { path: `${baseAdminPath}/translations`, icon: Languages, label: 'Translation Sync', active: true },
