        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="md:w-2/3 space-y-4">
            <h1 className="text-2xl sm:text-3xl font-bold text-white leading-tight">
              {languageCode === 'tr' ? 'Yapay Zeka Destekli İçerik Keşfi ve Akıllı İzleme Listeleri' :
               languageCode === 'de' ? 'KI-gestützte Inhalts-Entdeckung und Intelligente Watchlisten' :
               languageCode === 'fr' ? 'Découverte de Contenu Alimentée par l\'IA et Listes de Visionnage Intelligentes' :
               languageCode === 'es' ? 'Descubrimiento de Contenido Impulsado por IA y Listas Inteligentes' :
