...
export default function ShareListSelectModal({
  ...
  const [modalPosition, setModalPosition] = useState<{ top: number; left: number; right?: number } | null>(null);
  ...
  useEffect(() => {
    ...
    const calculatePosition = () => {
      ...
      const modalWidth = 400; // max-w-md = 28rem = ~448px, but we'll use 400 for safety
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div
        className="fixed bg-gray-800 rounded-lg p-6 w-full max-w-md z-[10001] shadow-2xl"
        style={modalPosition ? {
