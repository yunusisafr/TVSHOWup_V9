    ...
    <div ref={searchRef} className="relative w-full">
      <div className="relative">
        <input
          ...
          placeholder={languageCode === 'tr' ? 'Film ve dizi ara...' :
                       languageCode === 'de' ? 'Filme und Serien suchen...' :
                       languageCode === 'fr' ? 'Rechercher films et séries...' :
                       languageCode === 'es' ? 'Buscar películas y series...' :
                       languageCode === 'it' ? 'Cerca film e serie TV...' :
                       languageCode === 'ar' ? 'ابحث عن الأفلام والمسلسلات...' :
